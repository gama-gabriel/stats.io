...
export default function Mensagem( { referencia, tentativa, img_jogadores, resposta, acertou, terminou }: any) 
{
    ...
    <>
        <dialog ref={referencia} className='w-96 py-3 px-0 bg-purple-500 drop-shadow-2xl rounded-xl outline-none'>
        ...
        <div></div>
            ...
            <div className=" hover:cursor-pointer ml-auto me-3 w-fit h-fit group col-2">
